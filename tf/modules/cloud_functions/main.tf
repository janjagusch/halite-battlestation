...
data "archive_file" "source_zip" {
 ...
 output_path = "${path.root}/${local.file_name}"
}
...
#   project        = google_cloudfunctions_function.matches_to_bigquery.project
#   region         = google_cloudfunctions_function.matches_to_bigquery.region
#   cloud_function = google_cloudfunctions_function.matches_to_bigquery.name
